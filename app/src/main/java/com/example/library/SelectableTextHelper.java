...
public class SelectableTextHelper {
    ...
    public void setTouchXY(Integer mTouchX, Integer mTouchY){
    ...
    private class OperateWindow {
        ...
        public OperateWindow(final Context context) {
            ...
            contentView.findViewById(R.id.tv_ideabt).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (mSelectListener != null) {
                        mSelectListener.onClickIdeal(mSelectionInfo.mSelectionContent);
                    }
            ...
            contentView.findViewById(R.id.tv_copy).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (mSelectListener != null) {
                        mSelectListener.onClickCopy(mSelectionInfo.mSelectionContent);
                    }
                    SelectableTextHelper.this.resetSelectionInfo();
                    SelectableTextHelper.this.hideSelectView();
                }
